...
while IFS='' read -r line || [[ -n "$line" ]]; do
	...
	then
        ...
        do
            ...
            if (( $call == 1 ));
            then
     	        ./cadical -script 1 -t 300 -q -n '../../benches/sr19/new/'$line >> '19_formula/'c1_1_cadical21_lambda_formula.txt
		echo $line $(stat --printf="%s" states/internal_state1) $(stat --printf="%s" states/formula1)>> states/sizes/1_db_size
            fi
            if  (( $call == 2 ));
            then
     	        ./cadical -script 1 -t 2000 -q -n '../../benches/sr19/new/'$line >> '19_formula/'c2_1_cadical21_lambda_formula.txt
	        fi
            ((call+=1))
        done
        rm states/formula1
